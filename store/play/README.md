...
Paste this for the production upload of `1.0.0+13`. 492 of Play's 500,
...
- [ ] Upload `store/play/upload/app-release.aab` to a closed testing track
      first — `1.0.0+5`, signed and verified, see **Version** and **Signing**.
      Everything before it is superseded: `+3` could not build a share image at
      all, and `+4` built one with a yellow underline through every line of
      scripture on it. Both bugs were release-only and invisible in testing
